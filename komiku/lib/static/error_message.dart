class ErrorMessage {
  static const String loadComicError = "Failed to load comics";
  static const String loadComicEmpty = "No available comics";

  static const String loadComicSearchError = "Failed to load search results";
  static const String loadComicSearchEmpty = "No comics found";

  static const String loadComicDetailError = "Failed to load comic detail";
  static const String loadComicDetailEmpty = "No available comic detail";
